...
<head>
    ...
    <style>
        ...
        .news-title { font-size: 24px; color: #000000; } 
        .news-date { font-size: 14px; color: #666666; } 
        .news-content { font-size: 18px; color: #000000; } 
        ...
        .form-container button { padding: 10px 20px; background-color: #dc3545; color: #fff; border: none; cursor: pointer; } 
